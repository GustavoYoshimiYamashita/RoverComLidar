...
def transformando_polar_em_cartesiano(imagem, xGPS, yGPS):
    '''
    ...
    for i in range(len(imagem)):
        x = (imagem[i][0] * math.cos(imagem[i][1])) * 1.8
        #x = x - (imagem[i][0] * math.cos(angulo_compass)) * 40
        y = (imagem[i][0] * math.sin(imagem[i][1])) * 1.8
...
def desenhando_mapa_2D(pygame,surface, imagem_cartesiana, xGPS, yGPS):
    ...
    for i in range(len(imagem_cartesiana)):
        pygame.draw.line(surface, black, (xGPS, yGPS), (imagem_cartesiana[i][0], imagem_cartesiana[i][1]), 5)
        pygame.draw.circle(surface, white, (imagem_cartesiana[i][0], imagem_cartesiana[i][1]), 1)
    pygame.draw.circle(surface, red, (xGPS, yGPS), 5)


    x = 100 * math.cos(2.7)
    y = 100 * math.sin(2.7)
    pygame.draw.line(surface, red, (300, 300), (300 + x, 300 + y), 1)
